...
from research_summary.tools.prompts import ASSISTANT_SELECTION_PROMPT_TEMPLATE, WEB_SEARCH_PROMPT_TEMPLATE, \
    SUMMARY_PROMPT_TEMPLATE, RESEARCH_REPORT_PROMPT_TEMPLATE
...
llm = get_llm()
assistant_instructions_json = llm.invoke(assistant_selection_prompt)

assistant_instructions_dict = json_to_object(assistant_instructions_json.content)
...
web_search_queries_list = json_to_object(web_search_queries.content.replace('\n', ''))
